...
func NewMeshRenderer(win *Window) (*MeshRenderer, error) {
	...
	r.uniforms.ambient = r.prog.UniformVector3("materialAmbient")
	r.uniforms.diffuse = r.prog.UniformVector3("materialDiffuse")
	r.uniforms.specular = r.prog.UniformVector3("materialSpecular")
	r.uniforms.ambientMap = r.prog.UniformSampler("materialAmbientMap")
	r.uniforms.diffuseMap = r.prog.UniformSampler("materialDiffuseMap")
	...
	r.uniforms.lightDir = r.prog.UniformVector3("lightDirection")
	r.uniforms.ambientLight = r.prog.UniformVector3("lightAmbient")
	r.uniforms.diffuseLight = r.prog.UniformVector3("lightDiffuse")
	r.uniforms.specularLight = r.prog.UniformVector3("lightSpecular")
	...
	r.uniforms.alphaMap = r.prog.UniformSampler("materialAlphaMap")
